...
<body class="bg-gradient-to-br from-indigo-950 via-purple-950 to-zinc-950 p-3">
    ...
    <div class="flex items-center gap-3">
            ...
            <div onclick="showResponsiveAside()" class="bg-white/5 border border-white/10 p-1.5 rounded-lg text-white cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" viewBox="0 0 24 24">
                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h18M3 12h18M3 19h18"></path>
                </svg>
                </div>
    </header>
    <div class="flex gap-4">
        <aside id="responsiveAside" class="space-y-5 bg-white/5 border border-white/10 rounded-lg w-xs px-3 py-5 fixed shrink-0 "
            ...
            <div class="flex items-center gap-3">
             ...
             <div onclick="closeResponsiveAside()" class="lg:hidden bg-white/5 border border-white/10 p-1.5 rounded-lg text-white cursor-pointer">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" viewBox="0 0 24 24">
                    <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M19.5 12h-15m0 0l5.625-6M4.5 12l5.625 6"></path>
                </svg>
            </div>
            </div>
            <hr class="border-0 bg-white/10 h-0.5">
            <ul class="space-y-2 relative">
                <li class="rounded-lg p-2 relative navigaton-hover {{ request()->routeIs('user.dashboard') ? 'active' : '' }}">
                    <a class="flex items-center gap-2 text-white text-sm" href="{{ route('user.dashboard') }}" wire:navigate >
                ...
                <li class="rounded-lg relative p-2 navigaton-hover {{ request()->routeIs('user.deposit') ? 'active' : '' }}">
                    <a class="flex items-center gap-2 text-white text-sm" href="{{ route('user.deposit') }}" wire:navigate >
                ...
                <li class="rounded-lg relative p-2 navigaton-hover {{ request()->routeIs('user.transfer') ? 'active' : '' }}">
                    <a class="flex items-center gap-2 text-white text-sm" href="{{ route('user.transfer') }}" wire:navigate>
                ...
                <li class="rounded-lg relative p-2 navigaton-hover {{ request()->routeIs('user.transaction') ? 'active' : '' }}">
                    <a class="flex items-center gap-2 text-white text-sm" href="{{ route('user.transaction') }}" wire:navigate>
                        <svg xmlns="http://www.w3.org/2000/svg" width="19" viewBox="0 0 24 24">
                            <path fill="currentColor"
            ...
            <ul class="absolute bottom-4 space-y-2" style="width: calc(100% - 24px);">
                <li class="bg-white/5 border border-white/10 rounded-lg p-2 hover:border-indigo-500/50">
                    <a class="flex items-center gap-2 text-white text-sm" href="{{ route('user.setting') }}" wire:navigate>
                ...
                <li class="bg-white/5 border border-white/10 rounded-lg p-2 hover:border-indigo-500/50">
                    <a class="flex items-center gap-2 text-white text-sm" href="{{ route('user.profile') }}" wire:navigate>
                        <img class="rounded-full object-cover w-8 h-8" src="assets/irfan.jpeg" alt="">
