<form wire:submit.prevent="login">
    ...
    <div class="mb-10">
        ...
        <p class="text-zinc-400 text-sm tracking-wide mt-1">New user? <a href="{{ route('register') }}" wire:navigate
                class="text-indigo-400 hover:text-indigo-300 underline">Create account</a></p>
    </div>
